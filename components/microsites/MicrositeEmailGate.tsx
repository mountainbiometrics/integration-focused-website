...
export default function MicrositeEmailGate({
      ...
      <div className="space-y-4">
        ...
        {papers.map((paper) => (
          <a
            ...
            href={paper.filePath}
            download
            className="flex items-center gap-4 p-4 min-h-[56px] border border-[var(--ms-border)] rounded-lg hover:border-[var(--ms-primary)] hover:bg-[var(--ms-hero-gradient)] transition-all no-underline group"
          >
            <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-[var(--ms-primary)] flex items-center justify-center">
              <svg
            ...
            <div className="flex-1 min-w-0">
              <p className="font-medium text-[var(--ms-heading)] group-hover:text-[var(--ms-primary)] transition-colors">
                {paper.title}
              </p>
              {paper.subtitle && (
            ...
            <svg
              className="w-5 h-5 text-[var(--ms-muted)] group-hover:text-[var(--ms-primary)] transition-colors flex-shrink-0"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
  ...
  return (
    <div>
      <div className="mb-6">
        <h3 className="text-lg font-semibold text-[var(--ms-heading)] mb-2">
        ...
        <div className="space-y-2 mb-6">
          {papers.map((paper) => (
            <div key={paper.filePath} className="flex items-start gap-3">
              <svg
                className="w-5 h-5 text-[var(--ms-primary)] mt-0.5 flex-shrink-0"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
