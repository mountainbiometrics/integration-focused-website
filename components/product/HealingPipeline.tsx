...
/* ── Row 1: New field added ──────────────────────────────────────────
   Field list on left, new field slides in, arrow → "Mapped" on right */
...
/* ── Row 2: Field renamed ────────────────────────────────────────────
   Old name strikes through → new name, values match below           */
...
/* ── Row 3: Type conversion ──────────────────────────────────────────
   String → date with transform icon between                         */
...
/* ── Row 4: Structure change ─────────────────────────────────────────
   Nested object → flat fields, audit badge                          */
