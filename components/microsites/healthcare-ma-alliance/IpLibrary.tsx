...
// the library does more. Canonical concepts (Patient, Encounter, Claim, etc.)
// get defined in engagement 1 alongside the foundation EHR mapping; subsequent
// engagements add new source coverage and refinements rather than new concepts.
const ENGAGEMENT_DEPOSITS = [
  {
    engagement: 'Engagement 1',
    tokens: ['Epic mapping', 'Annotation v1', 'MSO playbook', 'Drift baseline'],
  },
  {
    engagement: 'Engagement 2',
    tokens: ['athena mapping', 'Annotation v2', 'Dental playbook'],
  },
  {
    engagement: 'Engagement 3',
    tokens: ['eCW mapping', 'Drift signatures'],
  },
  {
    engagement: 'Engagement 4',
    tokens: ['NextGen mapping', 'Reviewer corpus'],
  },
  {
    engagement: 'Engagement 5',
    tokens: ['MEDITECH mapping'],
  },
] as const;
