...
const PAIRS_16 = pairwise(16);

export default function AiSharedLayerDiagram() {
  ...
  if (phase3 > 0.5) {
    ...
    connectionCount = Math.round(28 + phase2 * 92);
  } else {
    ...
    >
      <div className="container-site max-w-4xl mx-auto">
        ...
        <h2
          ...
          style={{ opacity: enterOpacity }}
        >
          Every acquisition multiplies your AI&nbsp;problem. Unless it&nbsp;doesn&rsquo;t.
        </h2>
        ...
        <p
          ...
          style={{ opacity: enterOpacity }}
        >
          Portco fifty doesn&rsquo;t re-map portcos one through&nbsp;forty-nine.
        </p>
      </div>
    </section>
  );
